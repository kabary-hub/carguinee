...
const FRENCH_WORDS_RE = /\b(le|la|les|un|une|des|est|sont|avec|pour|dans|pas|que|qui|je|tu|il|elle|nous|vous|ils|ont|mais|aussi|bien|cette|ce|mon|ma|mes|ton|ta|tes|son|sa|ses|de|du|au|aux|en|sur|par|ne|se|y|me|te|tout|plus|ici|meme|comme|encore|fait|rien|temps|vie|oui|merci|salut|bonjour|tres|peut|faire|aller|dire|venir|voir|croire|vouloir|pouvoir|devoir|jamais|toujours|comment|pourquoi|parce|maintenant|avant|apres|entre|faut|frere|propre|vraiment|cest|c'est|non|ok|ca|toi|moi|lui|eux|mien|mienne|tien|tienne|sien|sienne|notre|votre|leur|leurs|quelque|quelques|beaucoup|trop|moins|autre|autres|meme|pareil|pareille|exactement|certainement|probablement|certain|certaine|certains|certaines|toute|toutes|chaque|nul|nulle|aucun|aucune)\b/;
